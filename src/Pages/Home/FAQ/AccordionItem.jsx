...
const AccordionItem = ({ header, text }) => {
    ...
    return (
        <div className="single-faq mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-4 sm:p-8 lg:px-6 xl:px-8">
            ...
            >
                <div className="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-lg bg-[#54196d] bg-opacity-5 text-primary">
                    <svg
                        className={`duration-200 ease-in-out fill-[#10B981] stroke-[#10B981] ${active ? "rotate-180" : ""
                            }`}
                        width="17"
                        height="10"
                        viewBox="0 0 17 10"
